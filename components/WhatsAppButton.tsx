...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* ✅ TOOLTIP — RIGHT SIDE (left-full ml-3) */}
      <span className="absolute left-full ml-3 top-1/2 -translate-y-1/2 bg-slate-800 dark:bg-slate-700 text-white text-sm px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
        Chat on WhatsApp
      </span>
    </a>
  )
